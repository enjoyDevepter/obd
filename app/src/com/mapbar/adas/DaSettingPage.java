...
@PageSetting(contentViewId = R.layout.da_layout, toHistory = false)
public class DaSettingPage extends AppBasePage implements View.OnClickListener, BleCallBackListener {
