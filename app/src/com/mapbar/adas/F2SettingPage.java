...
public class F2SettingPage extends AppBasePage implements View.OnClickListener, BleCallBackListener {
    ...
    public void onResume() {
        ...
        f2_fault_bgV.setOnClickListener(this);
        f2_tired_bgV.setOnClickListener(this);
    ...
    private void showSetting(int viewId) {
        ...
        switch (viewId) {
            ...
            case R.id.f2_temp_bg:
                ...
                break;
            case R.id.f2_fault_bg:
            case R.id.f2_tired_bg:
                showWarm();
                break;
            case R.id.f2_speed:
    ...
    private void showMultifunctional() {
        dialog = CustomDialog.create(GlobalUtil.getMainActivity().getSupportFragmentManager())
                ...
                .setDimAmount(0.5f)
                .isCenter(true)
                .setWidth(OBDUtils.getDimens(getContext(), R.dimen.f2_ultifunctional_dailog_width))
    ...
    private void showNormalDailog(final int type, final String title, final boolean status) {
        dialog = CustomDialog.create(GlobalUtil.getMainActivity().getSupportFragmentManager())
                ...
                .setDimAmount(0.5f)
                .isCenter(true)
                .setWidth(OBDUtils.getDimens(getContext(), R.dimen.hud_normal_dailog_width))
    ...
    private void updateUI() {
        ...
        if (null != hudWarmStatus) {
            f2_faultV.setBackgroundResource(hudWarmStatus.isFaultWarmShow() ? R.drawable.f2_fault_show : R.drawable.f2_fault_dismiss);
            f2_vV.setBackgroundResource(hudWarmStatus.isVoltageWarmShow() ? R.drawable.f2_v_show : R.drawable.f2_v_dismiss);
            f2_tV.setBackgroundResource(hudWarmStatus.isTemperatureWarmShow() ? R.drawable.f2_t_show : R.drawable.f2_t_dismiss);
            f2_tiredV.setBackgroundResource(hudWarmStatus.isTiredWarmShow() ? R.drawable.f2_tired_show : R.drawable.f2_tired_dismiss);
        }
    }
