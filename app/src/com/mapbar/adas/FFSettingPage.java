...
@PageSetting(contentViewId = R.layout.ff_layout, toHistory = false)
public class FFSettingPage extends AppBasePage implements View.OnClickListener, BleCallBackListener {
