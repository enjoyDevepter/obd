...
@PageSetting(contentViewId = R.layout.p6_layout, toHistory = false)
public class P6SettingPage extends AppBasePage implements View.OnClickListener, BleCallBackListener {
