...
public class CustomInputView extends android.support.v7.widget.AppCompatEditText {
    ...
    private void getAtt(AttributeSet attrs) {
        ...
        bottomLineColor = typedArray.getColor(R.styleable.PayPsdInputView_bottomLineColor, R.color.input_buttom_color);
...
//        super.onDraw(canvas);
    ...
    private void drawPsdCircle(Canvas canvas) {
        circlePaint.setTextSize(OBDUtils.getDimens(this.getContext(), R.dimen.custom_input_text_size));
...
//                    circlePaint);
            ...
            canvas.drawText(getText().toString().substring(i, i + 1), startX / 2 + i * 2 * startX,
                    startY * 3 / 2,
                    circlePaint);
        }
    }
