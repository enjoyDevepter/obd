...
public final class BarUtils {
    ...
    public static int getActionBarHeight() {
        ...
        if (GlobalUtil.getMainActivity().getTheme().resolveAttribute(android.R.attr.actionBarSize, tv, true)) {
            return TypedValue.complexToDimensionPixelSize(
                    tv.data, GlobalUtil.getMainActivity().getResources().getDisplayMetrics()
            );
        }
        return 0;
    }
    ...
    private static void invokePanels(final String methodName) {
        try {
            ...
            Object service = GlobalUtil.getMainActivity().getSystemService("statusbar");
    ...
    public static void setNavBarVisibility(@NonNull final Window window, boolean isVisible) {
        ...
        for (int i = 0, count = decorView.getChildCount(); i < count; i++) {
            ...
            if (id != View.NO_ID) {
                String resourceEntryName = GlobalUtil.getMainActivity()
                        .getResources()
    ...
    public static boolean isSupportNavBar() {
        WindowManager wm = (WindowManager) GlobalUtil.getMainActivity().getSystemService(Context.WINDOW_SERVICE);
        if (wm == null) {
            return false;
        }
